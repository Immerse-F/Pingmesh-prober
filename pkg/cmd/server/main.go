...
func main() {
	...
	var (
		app        = kingpin.New(filepath.Base(os.Args[0]), "The FITI-server")
		configFile = app.Flag("config.file", "prober configuration file path.").Default("../../../prober.yml").String()
	)

	promlogConfig := promlog.Config{}

	app.Version(version.Print("FITI-server"))
